...
######################## 存储与读取模块 ###########################
torch.save(encoder.cpu(), '10-2DGaussion_encoder.pkl')
torch.save(decoder.cpu(), '10-2DGaussion_decoder.pkl')
torch.save(D.cpu(), '10-2DGaussion_D.pkl')

model1 = torch.load('10-2DGaussion_encoder.pkl')
model2 = torch.load('10-2DGaussion_decoder.pkl')
model3 = torch.load('10-2DGaussion_D.pkl')
